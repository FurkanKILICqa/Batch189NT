...
public class Animal {
    ...
    Primitivler arasında paretn child ilişkisi yoktur

    Static methodlar override edilemez yani içeriği değiştirilemez badi parantezinini içi yani "()"
    ...
    public void eat(){//methodun return type si void ise overriding yaparken type değiştirilemez
        //void değer üretmez sadece 1 kere işlem yapar void sadece bir işçidir
    ...
    public Integer multiply(Integer a, Integer b){//Byte Integer Double bunların hepsi kardeştir birbirlerinin yerini alamazlar
        //hepsi eşittir parent child ayni baba oğul ilişkisi yoktur ikisi birbiri ile eşitiir
