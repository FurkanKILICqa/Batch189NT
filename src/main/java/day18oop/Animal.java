...
public class Animal {
    ...
    /*
    1)Parentclassdaki methodu child class içinde özelleştirerek kullanmaya "Overriding" denir

    2)Overriding de method parantezine, methodun ismine yani

     final double pi=3.14;//final keywordunu methodlar ilekullanabiliriz
    ...
    public void eat(){//Privite methodlar Override edilemez
       // final double pi=3.14;//final keywordunu methodlar ilekullanabiliriz
