...
public class PassByValuePassByReference {
    ...
    public static void main(String[] args) {
        ...
        //Pass by Value referansı yolla demek yani adresi yolla demek
        //Adresyollanınca methot orjinal değere ulaşabilir ve orjinal değeri değiştirebilir ama javada değiştirmez
