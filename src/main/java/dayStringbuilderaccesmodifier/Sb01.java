...
public class Sb01 {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder sb2 = new StringBuilder();//Buranın toplam karakter alma sayısı 16 dır yetmediği zaman "2x+2" kapasite kadar + 2 verir

        System.out.println(sb2.length());//0//Üstünde bir veri olmadığı için her zaman "0" verir
        ...
        System.out.println(sb2.capacity());//34    //Bu method kapasiteyi söyler
        ...
        sb3.append("ali");//Küçük alan olan
