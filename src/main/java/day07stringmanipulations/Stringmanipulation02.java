...
public class Stringmanipulation02 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //abc@gmail.com ===> gmail
        //indexOf("@") methodu parantez içine yazilan ilk görünüm indexini verir

        String a = "abc@gmail.com";// index ler harlerin hepsi

        System.out.println(a.substring(4,9));//gmail// hard code en kötü koddur
