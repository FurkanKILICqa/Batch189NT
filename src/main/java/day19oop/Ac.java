...
public interface Ac  {
    ...
    /*
    4- Oop lerin hepsi: Inheritance - polimorfishm - encapsulatio - abstruction
     */
    //Eğer parent interface olursa parenti yapmak için extance yerine implements kullanılır
    //Java parentlar olduğunda multiple parenta müsade etmez ama biz bazen class lar çok fazla büyümemesi adına java interface oluşturdu
    //Interface methodları abstruct olur içerisine conriat method koyamayız yani süslü parantez koyamayız içine birşey
    //yazamayız
    //Interface ler to do list yani yapılacaklar listesi demektir
    ...
    int price =2000;//Bu bir final method dur

    public void cool(); //Buraya abstruct yazmayız çünkü bu bir ınterface dir zaten java bunun abstruct olduğunu biliyor

    void run(); //Burası public ve abstract dır


    default void eco(){//Interfaceler de defoult kullanarak //Concrit class larda defoult olmadığı zmaan defoluttur
                                                // ama Interface lerde yazmak gerekeir
        System.out.println("uses gas less");

    }//Conclict tir çünkü süslü parantezi var
