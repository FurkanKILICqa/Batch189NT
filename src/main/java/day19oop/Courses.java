...
public abstract class Courses {//Objeler classlardan oluşturulur //Absrruction yapmak istersek classı abstract yapmalıyız
    //Yani yanına abstruct yaz

    //Abstruction

    //Amacımız objeleri kaategorilere ayırırız
    //Sadece child clasın yapmaları gereken görevleri yapmasını istiyorsak bu abstruction dur.
    //Badisi olmayan methoda Abstruction  denir "{}" bu badidir
    //Baody si olmayan methodları child classlar kullanmak zorundadır
    //Baody demek süslü parantez demektir
    //Methodu abstruct yaparak childlerin ne yapması gerektiğini belirleriz sadece
    //Abstruct eksik obje oluşturur abstruct class ın abstruct childi de olur
    ...
    public abstract void math();//Abstract method abstract classa kunur yani üstteki calssın yanını abstract yazmanız gerekir
    //public final abstract void sciance();




    public void art (){//Conread method yani badisi olan method //Art seçmeli dersoldu child ler bu class ı kullanmak zorunda değil
