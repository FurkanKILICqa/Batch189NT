...
public class Maps3 {
    public static void main(String[] args) {
        ...
        String words [] = s.split(" ");//Çoklu dataları arrayile yazdırırız
        ...
        for ( String w:words) {
           ...
           Integer numOfOccurance = occ.get(w);//Key verilir var ise value yi verir eğer value yoksa null verir
